...
## Ethernet Bootloader Applications Release v3.5.0

### New Features

- This release includes support of
    - UDP Live update Bootloader Applications for PIC32CZ-CA80 devices.
...
- The following table provides bootloader demo applications available for different development kits.
    ...
    | PIC32CZ CA80                   | [PIC32CZ-CA80 Curiosity Ultra board](https://www.microchip.com/en-us/development-tool/ea61x20a)                    | Yes              |      Yes         |
...
- Regenerated and tested PIC32CZ CA80 Curiosity Ultra UDP Bootloader Applications 

### Development Tools
- Same as v3.4.0

## Ethernet Bootloader Applications Release v3.4.0

### New Features

- This release includes support of
    - UDP Bootloader Applications for PIC32CZ-CA70 and PIC32CK-GC01 family of 32-bit microcontrollers.
...
## Ethernet Bootloader Applications Release v3.3.0

### New Features

- This release includes support of
    - UDP Bootloader Applications for PIC32CZ CA family of 32-bit microcontrollers.
